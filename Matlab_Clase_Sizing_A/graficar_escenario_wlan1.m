...
%==========================================================================
print -dpng -r700 No_Optimal_AP_LPSolve_0;
print -depsc -r450 No_Optimal_AP_LPSolve_0;
%==========================================================================
hold off; 
%==========================================================================
...
% e = findobj('Color','b');
% v1 = [e(1)];% Variables color para leyenda
leyenda=legend([z4,z5,z6],'Estudiantes','# AP Óptimo','XX %-Cobertura','Location','SO','Orientation','horizontal');
set(leyenda,'FontName','Times New Roman','FontUnits','points','FontSize',8,'FontWeight','normal','FontAngle','normal')
%==========================================================================
        hold off; 
    end
%==========================================================================
print -dpng -r700 Optimal_AP_LPSolve;
print -depsc -r450 Optimal_AP_LPSolve;
%==========================================================================